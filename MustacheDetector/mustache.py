...
noses = myFace.find #find the nose
...
# these get the upper left corner of the face/nose with
...
#blit(attach) the stache(mask) onto the image

img = img.blit(stache, pos=(xmust,ymust), mask = mask)

img.save(display) #display result
